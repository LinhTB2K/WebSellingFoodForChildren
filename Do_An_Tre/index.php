...
<head>	
    ...
    <title>Matsuya - Dinh dưỡng vượt trội - tiện lợi gấp đôi</title>    
	...
	<div id= "footer">
		<div id="footer1">
		  <div class="box"> 
		    ...
		    <p align="center">CÔNG TY TNHH SX TM DV LÊ MÂY</p>
		  </div>
			<div class="box1">
				<div id = "box_footer1">
					<ul>
		  ...
		  <div class="box3">
			...
			<p>Địa chỉ: Số 10, Đường 23, Ấp Bình Khánh 2, P. Bình An, Q.2, TP. Hồ Chí Minh </p>
				<p>Điện thoại: (028) 7304 9998  </p>
				<p>Email: info@lemay.com.vn</p>
		  </div>
		...
		<div id="footer2">
			<span>© Bản quyền thuộc về Công ty TNHH SX TM DV Lê Mây </span>|<a href="#"> Cung cấp bởi Sapo</a>
		</div>
	</div>
	</div>
